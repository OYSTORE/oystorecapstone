                        ...
                        <div className="block md:hidden w-full">
                            ...
                            <div className="flex flex-row mr-2 w-full shadow-md overflow-x-scroll">
                                ...
                                <div className="p-2 flex flex-row  gap-2">
                                    ...
                                    <button className="text-sm px-1 w-full border rounded-lg my-1 hover:border-orange-peel hover:bg-orange-peel dark:hover:border-blue-600 dark:hover:bg-blue-600 hover:text-white transition-all ease-in-out " onClick={() => filterItem("Noodles")}>Nooles</button>
