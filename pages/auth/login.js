                ...
                <div className="p-2">
                    ...
                    <div className="">
                        <div className="flex flex-col px-3 text-justify">
                            ...
                            <p className="indent-5">
                                A cookie is a small file which asks permission to be placed on your computer&apos; hard drive. Once you agree, the file is added and the cookie helps analyses web traffic or lets you know when you visit a particular site. Cookies allow web applications to respond to you as an individual. The web application can tailor its operations to your needs, likes and dislikes by gathering and remembering information about your preferences.
