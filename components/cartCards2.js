...
const CartCards = ({cardid, dish, handleAdd, text}) => {
    
    const dishCart = dishes.filter((curElem) => {
        return curElem.main_category === categItem;
    })
    return ( 
        <div className="max-w-[17rem] py-3 px-3">
                ...
                {/*<div className="w-[200px] h-[200px] bg-fixed" style={dishbg} >daoishdoashodhao</div>*/}
                    ...
                    <span className="text-sm font-bold text-[#fa812f] dark:text-white">
