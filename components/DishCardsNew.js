...
function DishCardsNew({ dish, handleAdd, handleRemove, dishID, carts }) {
    ...
    return (
        <div className="dark:bg-slate-800 flex flex-row sm:flex-col w-11/12 sm:w-56 h-48 sm:h-[22rem] rounded-none sm:rounded-xl shadow-md hover:shadow-lg transition duration-300 hover:scale-105 my-2 bg-white">
